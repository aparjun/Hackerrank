...
def integer_to_english(number):
    ...
    t={1:"ten",2:"twenty",3:"thirty",4:"forty",5:"fifty",6:"sixty",7:"seventy",8:"eighty",9:"ninty"}
    h={1:"one hundred",2:"two hundred",3:"three hundred",4:"four hundred",5:"five hundred",6:"six hundred",7:"seven hundred",8:"eight hundred",9:"nine hundred"}
    if(l==0 or int(number)>1000):
        s="-1"
    elif(l==1):
        s=o[int(number)]
    elif(l==2):
